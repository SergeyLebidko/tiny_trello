...
// Защита типа для определения Board
export function isBoard(e: Board | Card | Task | null): e is Board {
    return e !== null && ('userId' in e);
}

// Защита типа для определения Card
export function isCard(e: Board | Task | Card | null): e is Card {
    return e !== null && ('boardId' in e);
}

// Защита типа для определения Task
export function isTask(e: Board | Task | Card | null): e is Task {
